...
<html>
    ...
    <body>
        ...
        <section class="p-8">
            <form:form class="form-horizontal" action="../edited" modelAttribute="editFlight" method="post">
                <fieldset>

                    <legend>Editar vuelo</legend>

                    <div class="form-group">
                        <label class="col-md-4 control-label" for="idFlight">ID Vuelo</label>
                        <div class="col-md-4">
                            <form:input type="text" id="idFlight" path="idFlight" class="form-control imput-md" readonly="true"/>
                        </div>
                    </div>
